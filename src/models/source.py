...
class SourceObj(BaseModel):
    ...
    source_url: str = Field(description = "The source url. If AI generated, the source url identified by the AI agent.")
    source_name: str | None = Field(description="The name of the of the source. I.e. 'CivicPatch' or 'OpenStates'. Not required for human researchers.")
