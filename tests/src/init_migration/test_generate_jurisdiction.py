...
class TestJurGeneratorInitialization:
    ...
    def test_jur_generator_with_division(
        self, sample_generator_request, sample_division
    ):
...
class TestAILookup:
    ...
    def test_ai_lookup_enabled_raises_not_implemented(
        ...
        with pytest.raises(
            NotImplementedError, match="AI jurisdiction lookup is not yet implemented"
        ):
...
class TestGenerateJurisdiction:
    ...
    def test_generate_requires_division(self, jur_generator):
        ...
        with pytest.raises(ValueError, match="Division object or ocdid is missing"):
            jur_generator.generate_jurisdiction(division=None, uuid=jur_generator.uuid)
    ...
    def test_generate_requires_division_ocdid(self, jur_generator):
        ...
        with pytest.raises(ValueError):
            jur_generator.generate_jurisdiction(
                division=bad_division, uuid=jur_generator.uuid
            )
    ...
    def test_generated_jurisdiction_sourcing(self, jur_generator, sample_division):
        ...
        jurisdiction = jur_generator.generate_jurisdiction(
            division=sample_division, uuid=jur_generator.uuid
        )
...
class TestJurisdictionExistence:
    ...
    def test_jurisdiction_exists_returns_bool(self, jur_generator):
        ...
        result = jur_generator._jurisdiction_exists(
...
class TestDumpJurisdiction:
    ...
    def test_dump_jurisdiction_creates_file(
        self, jur_generator, sample_division, tmp_path
    ):
    ...
    def test_dump_jurisdiction_file_contains_valid_yaml(
        self, jur_generator, sample_division, tmp_path
    ):
    ...
    def test_dump_jurisdiction_requires_generated_jurisdiction(
        self, jur_generator, tmp_path
    ):
...
class TestJurisdictionGenerationIntegration:
    ...
    def test_full_workflow_division_to_jurisdiction(
        ...
        jurisdiction = jur_gen.generate_jurisdiction(
            division=sample_division, uuid=jur_gen.uuid, classification="government"
        )
